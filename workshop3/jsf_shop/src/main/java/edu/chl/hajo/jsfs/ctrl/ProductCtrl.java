...
public class ProductCtrl {
    ...
    private DeleteProductBB deleteBB;
    ...
    public void updateProduct() {
        Product p = new Product(Long.valueOf(editBB.getId()),editBB.getName(), Double.valueOf(editBB.getPrice()));
        shop.getProductCatalogue().update(p);
    }

    public void deleteProduct() {
        shop.getProductCatalogue().delete(Long.valueOf(deleteBB.getId()));
    }
    ...
    @Inject
    public void setDeleteBB(DeleteProductBB deleteBB) {
        this.deleteBB = deleteBB;
    }
