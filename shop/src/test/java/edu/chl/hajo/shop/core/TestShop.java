...
public class TestShop {
    ...
    public void testFindRangeProducts() {
        ...
        ps = s.getProductCatalogue().findRange(-1, 4);
        assertTrue(ps.isEmpty());
        
        ps = s.getProductCatalogue().findRange(18, 4);
        assertTrue(ps.isEmpty());
        
        ps = s.getProductCatalogue().findRange(17, 4);
    ...
    public void getAllOrdersAndItems() {
        ...
        assertTrue(ps.size() == 1);
        assertTrue(ps.get(0).getItems().size() == 2); 
    }
